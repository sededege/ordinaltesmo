      ...
      {data.state === "live" && data.type === "points" &&(
        <div className="bg-tesmo bg-opacity-80 rounded-lg p-4">
                      ...
                      {data.winner.map((a, index) => (
                        <li key={index} className="justify-between bg-tesmo  w-full p-2 items-center flex ">
                          ...
                          {a.transaction !== "" ? (
                            ...
                            whitelist.includes(ordinal  && ordinal ) ? (
          ...
          <div className="flex justify-between items-center">
            {
               whitelist.includes(ordinal  && ordinal) && <button onClick={() => deleteraffle(id)} className="bg-red-400 text-white p-2 rounded-lg mb-4">Delete</button>
            }
            <p className="text-white font-bold mb-4 text-[0.8rem]">
              Raffle # {number + 1}{" "}
            </p>
          ...
          <div className="text-center text-[0.8rem]  justify-between flex px-4 text-slate-400 mt-2 mb-2">
            ...
            <div className="flex items-center gap-2 justify-center">
              <GiTwoCoins className="text-yellow-300 text-[1.2rem]" />
        ...
        /> */}
          ...
          {ordinal && (
            <div className="text-center text-[0.8rem] justify-between flex px-4 text-slate-400 mt-2 mb-2">
              ...
              <p>{real ? calculatetickets(real,ordinal ) : 0}</p>
            </div>
          )}
          {real ? (
            data.winner ? (
