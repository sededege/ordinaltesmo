...
const Rewards = () => {
  ...
  const whitelist = ["bc1q5fz2zwj9pw54986yyjn35pxvpvage7u4e2jtg5"];
  ...
  const upd = async () => {
    setUser(await getUser(ordinal && ordinal));
  };
        ...
        <div className="w-full ">
          <div className="flex items-center justify-between mt-4 gap-2  ">
            <div className="flex items-center justify-center">
              ...
              <GiTwoCoins className="ml-4 text-yellow-300 font text-[1.2rem]" />
              <p className="text-yellow-300 font text-[1.2rem] ml-2">
              ...
              <p className="text-sky-500 font text-[1.2rem] ml-2">
                {user && user.diamondpoints ? user.diamondpoints?.toFixed(2) : 0}
              </p> */}
            </div>
            <div className="flex gap-2">
              {whitelist.includes(ordinal && ordinal) && <Sendpoints />}
